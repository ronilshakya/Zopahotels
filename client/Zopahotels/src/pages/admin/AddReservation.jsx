...
const AddReservation = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="max-w-6xl mx-auto p-6 bg-white rounded-xl shadow-lg mt-8 relative">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
                {bookingData.rooms.map((r, index) => (
                  <div key={index} className="mb-3 border border-gray-300 bg-gray-50 p-3 rounded-md relative">
                    {/* Room Type */}
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        {bookingData.rooms.length > 1 && (
                          <button
                            ...
                            className="text-white bg-red-500 p-1 rounded-lg hover:bg-red-600"
                          >
                      ...
                      <select
                        ...
                        className="mt-1 block mb-2 w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
                        required
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="mt-1 mb-2 block w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
                      >
                        ...
                        {r.roomId &&
                          (() => {
                            ...
                            const excludedStatuses = ["maintenance", "dirty", "cleaning_in_progress"]; 
                            const excludedCount = roomType.rooms.filter( (room) => excludedStatuses.includes(room.status) ).length; 
                            const maxSelectable = Math.max(availableRoomCounts[r.roomId] - excludedCount, 0);
